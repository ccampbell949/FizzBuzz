...
- I split the game logic into it's own class, and then tried to improved the useability of the program by asking the user inputs, such as what number they wanted to use (rather than just hardcoding n=50 or similar)
...
the user to easily exist the program, if for example they'd have had enough of playing this absolutely _scintillating_ game, or maybe if they've simply opened it accidentally.
